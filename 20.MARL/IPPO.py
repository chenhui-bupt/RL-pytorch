...
class PolicyNet(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        return F.softmax(self.fc3(x), dim=1)  # 随机策略
...
agent_size = 2
grid_size = (15, 15)
# 创建Combat环境，格子世界的大小为15*15，己方智能体和敌方智能体数量都为2
env = Combat(grid_shape=grid_size, n_agents=agent_size, n_opponents=team_size)
